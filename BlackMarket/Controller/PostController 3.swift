...
class PostController: UIViewController, UITextFieldDelegate {
    ...
    private let productImage: UIImageView = {
        ...
        view.image = #imageLiteral(resourceName: "Electronics")
        return view
    }()
    ...
    private func configureUI(){
        ...
        productImage.anchor(top: topStack.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 10,
        ...
        stackView.anchor(top: productImage.bottomAnchor, left: view.leftAnchor, right: view.rightAnchor, paddingTop: 10,
